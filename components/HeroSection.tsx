...
import modelImg2 from "@/public/model-image-2.png";
...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="relative flex flex-col items-center bg-background p-6 md:px-10 md:pt-4  pb-32 overflow-hidden"
    >
      <RectSVG />
      {/* Top Navigation Bar */}
      <motion.div
      ...
      >
        <div className="font-heading text-lg md:text-lg font-black tracking-tighter text-foreground">
          DIKSHA PUNYANI
          <span className="opacity-80 font-light italic ml-1">ARTISTRY</span>
        </div>
      ...
      <div className="absolute inset-0 pointer-events-none ">
        <motion.div
          ...
          className="absolute top-[-10%] right-[-10%] w-150 h-150 text-primary/30 md:text-foreground"
        >
                ...
                <svg className="absolute w-full h-full" viewBox="0 0 100 100">
                  ...
                  <text className="fill-background text-[7.5px] font-black uppercase tracking-widest leading-none">
                    <textPath href="#badgePath">
                      • Professional Beauty Artistry • Diksha Artistry •
                      Professional
                    </textPath>
                  </text>
                </svg>
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-start  ">
              ...
              <div className="flex flex-col justify-between h-full py-1">
                <p className="font-body text-[13px] text-foreground leading-relaxed mb-6 font-medium">
                  Meet Diksha, a artistry expert dedicated to celebrating your
                  beauty. Specializing in flawless makeup and bespoke nail
                  designs for every precious moment.
                </p>
                <div className="flex flex-wrap gap-x-6 gap-y-2">
                  {[
                    {
                      label: "Instagram",
                      href: "https://www.instagram.com/dikshapunyani.artistryy?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
                      hoverClass:
